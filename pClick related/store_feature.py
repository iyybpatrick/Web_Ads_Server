...
if __name__ == "__main__":
    input_dir = "/Users/yuebinyang/project/SearchAds/data/log/"
    ...
    device_id_click = input_dir + "demo_device_id_click"
    device_id_impression = input_dir + "demo_device_id_impression"

    device_ip_click = input_dir + "demo_device_ip_click"
    device_ip_impression = input_dir + "demo_device_ip_impression"

    ad_id_click = input_dir + "demo_ad_id_click"
    ad_id_impression = input_dir + "demo_ad_id_impression"

    query_campaign_id_click =  input_dir + "demo_query_campaign_id_click"
    query_campaign_id_impression = input_dir + "demo_query_campaign_id_impression"

    query_ad_id_click = input_dir + "demo_query_ad_id_click"
    query_ad_id_impression = input_dir + "demo_query_ad_id_impression"
