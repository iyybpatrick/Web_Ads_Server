...
if __name__ == "__main__":
    ...
    data = sc.textFile("/Users/yuebinyang/project/SearchAds/data/log/ctr_features_sample/part*")
    ...
    # Save and load model
    model.save(sc, "/Users/yuebinyang/project/SearchAds/data/model/ctr_logistic_model_without_bias_sample")
    # $example off$
